 ...
 */
public class ExtractWordsFromLexicalRules {
    ...
    public ExtractWordsFromLexicalRules(String conllFile){
    ...
    public static void main (String [] args){
        ...
        ExtractWordsFromLexicalRules createFSAforUDP = new ExtractWordsFromLexicalRules(DATASET_LOCATION);
