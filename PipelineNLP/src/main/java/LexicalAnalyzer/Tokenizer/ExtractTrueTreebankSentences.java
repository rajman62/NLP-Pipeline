...
public class ExtractTrueTreebankSentences {
    ...
    private static String TREEBANK_PATH_FOLDER = PARSED_DEPENDENCIES_TREEBANK_PATH_FOLDER
            + "parsedDependenciesConLL_train.ser";
    ...
    public static void main(String[] args) {
        try {
            ...
            for (int i = 0; i < parsedDependenciesConLL.size(); i++) {
                ...
                sentence = sentence + parsedDependenciesConLL.get(i)
                        .get(parsedDependenciesConLL.get(i).size() - 1).getForm();
