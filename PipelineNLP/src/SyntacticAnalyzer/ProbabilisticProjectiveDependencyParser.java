 ...
 * @Date 5/9/17
 */
public class ProbabilisticProjectiveDependencyParser {
    ...
    /*
    public ProbabilisticProjectiveDependencyParser(ArrayList<String>  tokens){
        probabilisticGrammar = new DependencyGrammar(grammarFile);
        labels = probabilisticGrammar.getLabels();
    ...
    */
    ...
    public ProbabilisticProjectiveDependencyParser(ArrayList<String>  tokens, ArrayList<DependencyGraph> dependencyGraphs){
        train(dependencyGraphs);
    }
     ...
     * DependencyGraphs in conll-format.  This model is an implementation of Eisner's (1996)
     * Model C, which derives its statistics from head-word, head-tag,
     * child-word, and child-tag relationships.
     * @param dependencyGraphs
     */
    public void train(ArrayList<DependencyGraph> dependencyGraphs){
        ArrayList<String> productions = new ArrayList<String>();
        //TODO: events
        Set<String> tags = new HashSet<String>();

        for (DependencyGraph dg: dependencyGraphs){
